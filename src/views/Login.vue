<script setup>
import { User, Lock, UserFilled, Stamp } from '@element-plus/icons-vue'
import { ref } from 'vue'
...
const rules = {
    account:[
        ...
        {min:3, max:16, message:'账号应为3~16位数字', trigger:'blur'}
    ],
    username:[
        {required:true, message:'请输入用户名', trigger:'blur'},
        {min:3, max:10, message:'用户名应为3~10位非空字符', trigger:'blur'}
    ],
    password:[
    ...
    truename:[
        ...
        {min:1, max:100, message:'真实姓名不能为空', trigger:'blur'}
    ]
}
        ...
        <el-col :span="6" :offset="3" class="form">
            ...
            <el-form ref="form" size="large" autocomplete="off" v-if="isRegister" :model="registerData" :rules="rules">
                ...
                <el-form-item prop="account">
                    <el-input :prefix-icon="UserFilled" placeholder="请输入账号" v-model="registerData.account"></el-input>
                </el-form-item>
